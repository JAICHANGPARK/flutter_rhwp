...
mod tests {
    ...
    fn applies_commands_exports_and_reopens() {
        ...
        session
            .apply_command(
                r##"{"type":"applyCharFormat","section":0,"paragraph":0,"startOffset":0,"endOffset":2,"properties":{"bold":true,"italic":true,"underline":true,"strikethrough":true,"superscript":true,"subscript":false,"fontSize":1250,"textColor":"#dc2626","shadeColor":"#fef08a"}}"##
                    .to_string(),
            )
